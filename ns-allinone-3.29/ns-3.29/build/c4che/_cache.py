...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-PPrPZj/python2.7-2.7.15=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-PPrPZj/python2.7-2.7.15=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-PPrPZj/python2.7-2.7.15=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-g', '-fdebug-prefix-map=/build/python2.7-PPrPZj/python2.7-2.7.15=.', '-fstack-protector-strong', '-g', '-fwrapv', '-O2', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['stats', 'error-model', 'routing', 'wireless', 'udp-client-server', 'traffic-control', 'realtime', 'socket', 'tutorial', 'tcp', 'udp', 'naming', 'ipv6', 'matrix-topology', 'energy']
...
NS3_EXECUTABLE_PATH = ['/home/wagner/sumo-ns3/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/wagner/sumo-ns3/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/wagner/sumo-ns3/ns-allinone-3.29/ns-3.29/build/lib']
...
VALGRIND_FOUND = True
VERSION = '3.29'
WITH_PYBINDGEN = '/home/wagner/sumo-ns3/ns-allinone-3.29/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/wagner/sumo-ns3/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/wagner/sumo-ns3/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
